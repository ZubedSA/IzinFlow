...
export declare class PermissionController {
    ...
    create(tenantId: string, req: any, dto: CreatePermissionDto): Promise<{
        message: string;
        permissionId: string;
    }>;
    ...
    approve(tenantId: string, id: string, req: any, dto: ApprovePermissionDto): Promise<{
        message: string;
        status: "APPROVED";
    }>;
    reject(tenantId: string, id: string, req: any, dto: ApprovePermissionDto): Promise<{
        message: string;
        status: "REJECTED";
    }>;
}
